// ═══════════════════════════════════════════
// STATE — populated from /api/data on load
// ═══════════════════════════════════════════
...
const NAV_CONFIG = {
  admin: [
    ...
    { icon:'💪', label:'Trainers',        page:'trainers' },
...
const ROLE_USERS = {
  admin:   { name:'Admin User',   id:'ADMIN' },
  trainer: { name:'Arun Mehta',   id:'T1' },
  member:  { name:'Kiara Reddy',  id:'M101' },
};
...
function renderPage(page) {
  ...
  ca.innerHTML = renderers[page] ? renderers[page]() : `<div class="card"><p>Page not found</p></div>`;
  setTimeout(()=>{
